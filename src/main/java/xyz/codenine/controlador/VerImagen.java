 ...
 * @author ninus69
 */
@WebServlet(name = "VerImagen", urlPatterns = {"/Ver"})
public class VerImagen extends HttpServlet {
private static String LISTAR = "ver.jsp";
    /**
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ps = con.getConnection().prepareStatement("select dni_foto from persona where idPersona= ?");
            ps.setInt(1, id);
            rs = ps.executeQuery();
            while (rs.next()) {
                b = rs.getBytes(1);
